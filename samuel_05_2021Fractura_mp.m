% %%% Mis comentarios: se identifican con  % mp:
% clear 
% clc
% 
% 
...
% load('sec9.mat')
% 
% % mp: Usa un for, por ejemplo: 
% figure, hold on
% for i=0:6
%     frac=sec(i*20+1:(i+1)*20,:); % puedes cerrrar ...(i+1)*20+1, extendiendo sec
...
% mp: Como tienes puntos para 7 splines periodicos puedes ponerlos en un
% arreglo tridimensional de dimension 7x3xsize(sec). Usa for para
% construir los cuatro puntos de Bezier de cada segmento.
...
% M6 = [];
% M7 = []; 
% M = zeros(3,560); %matriz donde se guardan los puntos 
% v = [1 29 57 85 113 141 169 197 225 253 281 309 337 365 393 421 449 477 505 533 ];
% % coeficienters de la fucion f(t) 
...
%     
%     n1 = 3; %dimension del polinomio de Bézier 
%     
