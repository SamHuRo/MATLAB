function [C,U] = bspline_deboorA(n,t,P,U)
...
if nargin < 4
    U = linspace(t(d+1), t(end-d), 1*size(P,2));  % allocate points uniformly
elseif isscalar(U) && U > 1
    ...
    %%% Sept 27, en nuestro caso nargin siempre es 4, o sea este es SIEMPRE
    %%% el camino
else
